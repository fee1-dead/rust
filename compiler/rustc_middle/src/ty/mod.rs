...
impl<'tcx> Predicate<'tcx> {
    ...
    pub fn flip_polarity(self, tcx: TyCtxt<'tcx>) -> Option<Predicate<'tcx>> {
        let kind = self
            ...
            .map_bound(|kind| match kind {
                PredicateKind::Clause(Clause::Trait(TraitPredicate { trait_ref, polarity })) => {
    ...
    pub fn without_const(self, _tcx: TyCtxt<'tcx>) -> Self {
        // FIXME(#110395)
        self
    }
...
impl<'tcx> TraitPredicate<'tcx> {
    pub fn remap_constness(&mut self, _param_env: &mut ParamEnv<'tcx>) {
        // FIXME(#110395)
    }

    /// Remap the constness of this predicate before emitting it for diagnostics.
    pub fn remap_constness_diag(&mut self, _param_env: ParamEnv<'tcx>) {
        // FIXME(#110395)
    }
    ...
    pub fn is_constness_satisfied_by(self, _constness: hir::Constness) -> bool {
        // FIXME(#110395)
        true
    }
